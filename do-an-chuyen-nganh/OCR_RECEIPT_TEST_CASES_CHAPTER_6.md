...
| OCR07 | Xử lý hóa đơn hơi mờ | IMG04 | Upload ảnh hóa đơn hơi mờ | Hệ thống không bị lỗi, trả kết quả nếu đọc được và cho phép chỉnh sửa |
| OCR08 | Xử lý hóa đơn thiếu sáng | IMG05 | Upload ảnh hóa đơn thiếu sáng | Hệ thống xử lý được hoặc trả thông báo lỗi rõ ràng |
| OCR09 | Xử lý hóa đơn nghiêng/cắt góc | IMG06 | Upload ảnh hóa đơn không thẳng hoặc bị mất một phần | Hệ thống không tự lưu sai dữ liệu, người dùng có thể kiểm tra và chỉnh sửa |
...
| OCR06 | Gợi ý danh mục | IMG03 | Gợi ý danh mục ăn uống | Gợi ý đúng danh mục ăn uống | Đạt |  |
| OCR07 | Ảnh hơi mờ | IMG04 | Hệ thống không lỗi và cho phép chỉnh sửa | Nhận diện thiếu tên cửa hàng nhưng có thể sửa | Đạt có điều kiện | Cần người dùng xác nhận |
