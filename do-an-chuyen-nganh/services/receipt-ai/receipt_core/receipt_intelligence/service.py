...
def parse_receipt_and_suggest_category(
    *,
    ...
    try:
        ...
        category_name = category_suggestion.get("category_name") if category_suggestion else None
        ...
        review_fields = ReceiptOcrReviewFields(
            ...
            category_id=category_suggestion.get("category_id") if category_suggestion else None,
            category_name=category_name,
            category_reason=category_suggestion.get("reason") if category_suggestion else None,
            category_confidence=category_suggestion.get("confidence") if category_suggestion else None,
            category_needs_review=category_suggestion.get("needs_review") if category_suggestion else None,
