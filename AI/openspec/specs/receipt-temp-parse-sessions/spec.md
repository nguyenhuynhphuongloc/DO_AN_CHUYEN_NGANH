# receipt-temp-parse-sessions Specification

## Purpose
Defines the fast-path-first temporary receipt parse workflow and the timing/debug metadata recorded for review and troubleshooting.
