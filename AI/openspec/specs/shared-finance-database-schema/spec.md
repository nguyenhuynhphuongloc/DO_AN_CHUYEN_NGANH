# shared-finance-database-schema Specification

## Purpose
Define the shared Neon database structures required for OCR-driven receipt review and finance transaction persistence across services.
