# receipt-ai-category-selection Specification

## Purpose
Define how AI-assisted receipt category suggestions are constrained by the shared database and remain review-first rather than auto-applied.
