# receipt-layout-aware-ocr Specification

## Purpose
Defines the optional layout-aware OCR stage for receipt parsing, including semantic block detection, block-level OCR, fallback behavior, and benchmarkability.
