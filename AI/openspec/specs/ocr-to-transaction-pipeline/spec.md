# ocr-to-transaction-pipeline Specification

## Purpose
Define how parsed receipts persist draft state, feed review, and become linked finance transactions only after explicit user confirmation.
