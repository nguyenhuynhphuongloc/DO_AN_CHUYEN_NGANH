...
class Settings(BaseSettings):
    ...
    receipt_parser_provider: str = "veryfi"
    receipt_parser_preprocess_enabled: bool = True
    receipt_parser_preprocess_profile: str = "fast"
    receipt_parser_debug_include_provider_payload: bool = True
    receipt_parser_max_file_size_mb: int = 20
    veryfi_client_id: str = ""
    veryfi_client_secret: str = ""
    veryfi_username: str = ""
    veryfi_api_key: str = ""
    veryfi_base_url: str = "https://api.veryfi.com/api/"
